  ...
  head: () => ({
    meta: [
      ...
      { title: "Mohanad Ashraf — Machine Learning Engineer" },
      {
        name: "description",
        content:
          "Machine Learning Engineer specialising in real-time computer vision, NLP and deployed ML systems.",
      },
      { name: "author", content: "Mohanad Ashraf Ramadan" },
      { property: "og:title", content: "Mohanad Ashraf — Machine Learning Engineer" },
      {
        property: "og:description",
        content:
          "Real-time computer vision, NLP and recommendation systems, built end-to-end.",
      },
